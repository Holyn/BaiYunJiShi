...
//	private String[] mItemTexts;
	 ...
	 * 
	 * 我们只取heightMeasureSpec作说明。
	 * 这个值由高32位和低16位组成，高32位保存的值叫specMode，可以通过如代码中所示的MeasureSpec.getMode()获取；
	 * 低16位为specSize，同样可以由MeasureSpec.getSize()获取
	 * 
	 * 我们知道在ViewGroup中，给View分配的空间大小并不是确定的，有可能随着具体的变化而变化，
	 * 而这个变化的条件就是传到specMode中决定的，specMode一共有三种可能：
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		setMeasuredDimension(resWidth, resHeight);// 这个函数调用中传进去的值是View最终的视图大小
